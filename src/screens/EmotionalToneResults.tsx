...
type EmotionalToneResultsRouteProp =
  | RouteProp<MoviesStackParamList, 'EmotionalToneResults'>
  | RouteProp<TVShowsStackParamList, 'EmotionalToneResults'>;

type EmotionalToneResultsNavigationProp =
  | NativeStackNavigationProp<MoviesStackParamList, 'EmotionalToneResults'>
          ...
          if (item.type === 'movie') {
            ...
            return bestMatch
              ? {
                  ...
                  matchReason: item.matchReason || 'Matches the emotional tone',
