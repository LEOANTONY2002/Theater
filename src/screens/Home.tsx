...
export const HomeScreen = React.memo(
  ({onScroll, scrollEventThrottle}: HomeScreenProps = {}) => {
    ...
    const langMoviesSimple = useMoviesByLanguageSimpleHook(
    ...
    const sections = useMemo(() => {
      ...
      if (cinemaDNA && topActorData.actor && topActorData.isEnabled) {
        ...
        const actorShows =
          topActorData.tvCredits.data?.pages?.[0]?.results || [];
        const combinedContent = [
